...
namespace PHPPlugin\ApiServices\Charges\ResponseModels;
...
class Charge
{
	...
	{
		$cardObg = new \PHPPlugin\ApiServices\Cards\RequestModels\BaseCardCreate();
		$billingDetails  = new \PHPPlugin\ApiServices\SharedModels\Address();
	...
	{
		$shippingAddress  = new \PHPPlugin\ApiServices\SharedModels\ShippingAddress();
	...
	protected function _setProducts ( $products )
	{
		...
		if($productsArray) {
			foreach($productsArray as $item){
				$product  = new \PHPPlugin\ApiServices\SharedModels\Product();
	...
	protected function _setRefunds ( $refunds )
	{
		...
		$refundObj = new \PHPPlugin\ApiServices\Charges\ResponseModels\Refund();
